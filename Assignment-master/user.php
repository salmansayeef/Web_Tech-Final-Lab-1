...
//fetching data in descending order (lastest entry first)
    ...
    $sql = "SELECT * FROM info where deleted_at is NULL and uploaded_by='$user' order by id DESC LIMIT $start_from, $limit";
...
<br>
<a href="add.php"> <span class="btn btn-success">Upload New Assignment</span></a>
<a href="logout.php"><span class="btn btn-warning">Logout</span></a>
<center><h1>Assignment Uploading System</h1></center><hr>
<?php echo "<h4>Logged In as ". $_SESSION['aiubid']."</h4>"; ?>
...
for ($i=1; $i<=$total_pages; $i++) {
    $pagLink .= "<li class='page-item'><a href='user.php?page=".$i."'>".$i."</a></li>";
};
echo $pagLink . "</ul>";
